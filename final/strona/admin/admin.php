...
// Checks login credentials and session status
// Returns true if logged in successfully, error string if failed
...
// Generates login form for admin panel
// Parameter $error displays error message if present
...
// Displays list of all subpages in card format
// Includes buttons for editing, deleting and adding new pages
...
// Generates edit form for selected subpage
// Gets page data based on ID from GET parameter
...
// Deletes subpage with specified ID
// Redirects back to panel after deletion
...
// Displays form for adding new subpage
// Also handles saving new subpage to database
...
// Displays list of all categories in tree structure
...
// Generates form for adding/editing category
// Parameter $id is null for new category, contains ID for editing
...
// Handles adding new category to database
...
// Handles editing existing category
...
// Deletes category and updates its subcategories
...
// Displays list of all products in card format
...
// Checks product status based on its data
// Returns array with status text and CSS class
...
// Generates form for adding/editing product
// Parameter $id is null for new product, contains ID for editing
...
// Handles adding new product to database
...
// Handles editing existing product
...
// Manages display of appropriate views based on action
function PanelAdministracyjny() {
    ...
    if ($status === true) {
        ...
        $wynik .= '<a href="admin.php" class="btn-menu">Strony</a>';
