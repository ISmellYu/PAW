...
// Funkcja obsługująca wysyłanie wiadomości z formularza kontaktowego
function WyslijMailKontakt() {
    // Sprawdzenie czy formularz został wysłany
    if (isset($_POST['wyslij'])) {
        // Pobieranie i czyszczenie danych wejściowych
...
function PrzypomnijHaslo() {
    ...
    if (isset($_POST['przypomnij_haslo'])) {
        ...
        if ($email === $login) {
            // Przygotowanie i wysłanie wiadomości z hasłem
...
// Wywołanie funkcji obsługujących formularze
